...
class _DoctorHomepageState extends State<DoctorHomepage> {
  ...
  Future loadUser() async {
    ...
    setState(() {
      firstName = user?["firstName"] ?? user?["first_name"] ?? "Doctor";
  ...
  Future loadRequests() async {
    try {
      ...
      var data = await ApiService.getDoctorRequests(providerId);
          ...
          child: Padding(
            ...
            child: Column(children: [
              ...
              const Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                Text("Patient Requests", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: kDark)),
              ]),
                ...
                child: loading
                    ...
                    : requests.isEmpty
                        ? Center(child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                            Icon(Icons.local_hospital_outlined, size: 48, color: kMuted.withOpacity(0.5)),
                            const SizedBox(height: 12),
                            const Text("No patient requests", style: TextStyle(color: kMuted, fontWeight: FontWeight.w600)),
                          ]))
                        : ListView.builder(
