...
class CaregiverHomepage extends StatefulWidget {
  ...
  @override
  State createState() => _CaregiverHomepageState();
}
...
class _CaregiverHomepageState extends State<CaregiverHomepage> {
  ...
  Future loadUser() async {
    ...
    setState(() { firstName = user?["firstName"] ?? "User"; address = user?["address"] ?? ""; });
  }
  ...
  Future loadRequests() async {
    try {
      ...
      var data = await ApiService.getCaregiverRequests(providerId);
          ...
          child: Padding(
            ...
            child: Column(children: [
              ...
              const Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                Text("Service Requests", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: kDark)),
              ]),
                ...
                child: loading
                    ...
                    : requests.isEmpty
                        ? Center(child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                            Icon(Icons.favorite_outline_rounded, size: 48, color: kMuted.withOpacity(0.5)),
                            const SizedBox(height: 12),
                            const Text("No service requests", style: TextStyle(color: kMuted, fontWeight: FontWeight.w600)),
                          ]))
                        : ListView.builder(
                                ...
                                child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                  ...
                                  Padding(
                                    ...
                                    child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                      ...
                                      _infoRow(Icons.accessibility_new_rounded, "Disability: ${r['disability'] ?? 'None'}"),
                                      ...
                                      _infoRow(Icons.timelapse_rounded, "Duration: ${_calcDuration(r["booking_time"] ?? "", r["service_time"] ?? "")}"),
                                      _infoRow(Icons.attach_money_rounded,      "Total: ${r["payment_total"]} EGP"),
                                      if ((r["comment"] ?? "").toString().isNotEmpty)
                                        _infoRow(Icons.comment_rounded,         "Comment: ${r["comment"]}"),
                                      const SizedBox(height: 12),
